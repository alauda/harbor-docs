...
| `metadata.labels[tools.cpaas.io/template]`                   | Specifies the type of tool applicable to the template, for example, `harbor` indicates that this template is used to deploy Harbor. This value usually corresponds to the resource name of the tool instance |
