...
# more params run `docker run -ti --rm alaudadockerhub/chartmuseum2oci:v1.1.0-g41baf1e --help`
docker run -ti --rm alaudadockerhub/chartmuseum2oci:v1.1.0-g41baf1e --url $HARBOR_URL --username $HARBOR_USER --password $HARBOR_PASSWORD
```
