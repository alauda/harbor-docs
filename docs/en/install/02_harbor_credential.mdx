...
For detailed Redis deployment instructions, please refer to the [Harbor Official Documentation](https://goharbor.io/docs/2.14.0/install-config/).
...
This feature is not currently supported: connecting to Alauda Cache Service for Redis OSS using **TLS mode**.
...
| Harbor Version | Supported PostgreSQL Versions |
|----------------|-------------------------------|
| 2.12.z         | 14.x                          |
| 2.14.z         | 15.x, 16.x                    |
...
1. Choose a PostgreSQL version that matches your Harbor version, for example, when deploying Harbor 2.14.x, you need to select PostgreSQL 15.x
...
For more information about storage, please refer to [Harbor Storage](./03_harbor_deploy.mdx#storage-yaml-snippets).
