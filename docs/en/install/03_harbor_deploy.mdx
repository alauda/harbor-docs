...
1. **Init Container Requires Root Privileges**: Harbor uses init containers to initialize PVC directory permissions, which requires root privileges that are not allowed under the Restricted policy.
